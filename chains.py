...
actor_prompt_template = ChatPromptTemplate.from_messages(
    [
        (
            ...
            3. Recommend search queries to research information and improve your answer. At all cost create the search queries, it's must item.""",
        ),
...
- you should use previous critique to add important information to your answer.
  ...
  - add a "Reference" section at the bottom of your answer (which doesnot count towards the word limit). In form of:
    - [1] https://example.com
    - [2] https://example.com
